...
from .views import CouponValidationView, CancelOrderAPIView, OrderDetailAPIView, UpdateOrderStatusView,get_order_status
...
urlpatterns = [
    ...
    path('api/orders/<str:order_id>/status/', get_order_status, name='get_order_status'),
]